        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            ...
            <v-card-actions class="pa-0">
              <p class="headline font-weight-light pt-3">30,000MMK <del style="" class="subtitle-1 font-weight-thin">50,000MMK</del></p>
              <v-spacer></v-spacer>
            </v-card-actions>
          ...
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row >
              ...
              <v-col class="col-12 col-sm-9 pr-4">
                ...
                <p class="font-weight-thin">Free Shipping over 30,000MMK</p>
              </v-col>
            </v-row>
          </v-col>
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row >
              ...
              <v-col  class="col-12 col-sm-9 pr-4">
                ...
                <p class="font-weight-thin">15 Days Money Back Guarantee</p>
              </v-col>
            </v-row>
          </v-col>
          <v-col class="col-12 col-md-4 col-sm-12">
            <v-row>
              ...
              <v-col  class="col-12 col-sm-9 pr-4">
                <h3 class="font-weight-light">09-000-000</h3>
    ...
    export default {
        data: () => ({
            ...
            items: [
                ...
                {
                    title: 'Lorem ipsum dolor <span class="grey--text text--lighten-1">',
                },
                {
